                ...
                <div class="col-sm-6 col-xs-12">
                    <figure class="wow fadeInLeft animated portfolio-item" data-wow-duration="500ms" data-wow-delay="0ms">
                        <div class="img-wrapper" align="center">
                            <?php
                                echo "<td><img src='./upload/".$row['prod_img']."' width='300px' height='250px'></td>";
                            ?>
                            <div class="overlay">
                                <div class="buttons">
                                   <?php 
                                        echo "<a rel='gallery' class='fancybox' href='userpanel2.php?brand_id=".$row['brand_id']."'> ";
                                       ?>
                        ...
                        <figcaption>
                        <h4 align="center" style="padding-right:50px;">
                        <a href="#">
