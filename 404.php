        ...
        <div class="row">
            <div class="col-md-12">
                <div class="text-center">
                    ...
                    <h2 class="wow fadeInUp animated" data-wow-delay=".6s"><b>Opps! You have some problems</b></h2>
                    <p class="wow fadeInUp animated" data-wow-delay=".9s"><b>The page you are looking for was moved, removed, renamed or might never existed.</b></p>
                    <a href="index.php" class="btn btn-dafault btn-home wow fadeInUp animated" data-wow-delay="1.1s"><span class="fa fa-home">&nbsp;&nbsp;Go Home</a>
