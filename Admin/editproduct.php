...
<body>
 ...
 <?php
            ...
            $qry = "SELECT * FROM product WHERE productid=".$_REQUEST['pid'];
    ...
    <div class="col-md-8"style="padding-left:15%;">
        <table border="1">
            <div class="">
                <center><h3 class="modal-title" id="myModalLabel"><b>Edit Product</b></h3></center>
            </div>
                <div class="container-fluid">
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-3">
                                        <thead>
                                            ...
                                            <input type="hidden" name="hdnpid" value="<?php echo $row['productid'];?>">
                                        </thead>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="col-md-3">
                                        <thead>
                                            <div style="padding-left:5%;" align="">
                                                <input  name="prod_name" class="form-control" value="<?php echo $row['prod_name']; ?>" type="text"required>
                                            </div>
                                        </thead>
                                    </div>
                                </div>
                             ...
                             <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-3">
                                        <thead>
                                            <div style="padding-left:5%;" align="">
                                                <input class="form-control" type="text" name="reprice"value="<?php echo $row['reprice'];?>" required>
                                            </div>
                                        </thead>
                                    </div>
                                </div>
                             ...
                             <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-3">
                                        <thead>
                                            <div style="padding-left:5%;" align="">
                                                <input class="form-control" type="date" name="mfgdate" value="<?php echo $row['mfgdate'];?>" required>
                                            </div>
                                        </thead>
                                    </div>
                                </div>
                             ...
                             <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-3">
                                        <thead>
                                            <div style="padding-left:5%;" align="">
                                                <input class="form-control" type="date" name="expdate"value="<?php echo $row['expdate'];?>" required>
                                            </div>
                                        </thead>
                                    </div>
                                </div>
                             ...
                             <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-3">
                                        <thead>
                                            <div style="padding-left:5%;" align="">
                                                <input class="form-control" type="file" name="prod_img"value="<?php echo $row['prod_img']; ?>" required>
                                            </div>
                                        </thead>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-3">
                                        <thead>
                                            <div style="padding-left:5%;" align="">
                                                <select name="brand_id" name="ddlbrand"class="form-control">
                                                    <?php   
