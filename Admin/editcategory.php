...
<?php
			...
			mysqli_select_db($con,"grocery") or die("could not connect select db");
			$qry = "SELECT * FROM category WHERE categoryid=".$_REQUEST['cid'];
	...
	<div class="col-md-8"style="padding-left:15%;">
		<table border="1">
	        <div class="">
	            ...
	            <div class="container-fluid">
	                <form method="POST" action="editcategorycode.php" enctype="multipart/form-data">
	                    		...
	                    		<div class="col-md-12">
	                    			<div class="col-md-3">
		                    			<thead>
		                    				...
		                    				<input type="hidden" name="hdncid" value="<?php echo $row['categoryid'];?>">
		                    			</thead>
		                    		</div>
	                    		</div>
	                    		<div class="col-md-12">
	                    			<div class="col-md-3">
		                    			<thead>
		                    				<div style="padding-left:5%;" align="">
		                    					<input class="form-control"value="<?php echo $row['cname']; ?>"  type="text" name="cname" required>
		                    				</div>
		                    			</thead>
		                    		</div>
	                    		</div>
