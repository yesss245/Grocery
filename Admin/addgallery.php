<html>
<head>
	<title> Admin Panal(Gallery)</title>
	<meta charset="utf-8">
...
<body>
	...
	<div class="col-md-8"style="padding-left:15%;">
		<table border="1">
	        <div class="">
	            <center><h3 class="modal-title" id="myModalLabel"><b>Add New Gallery</b></h3></center>
	        </div>
	            <div class="container-fluid">
	                <form method="POST" action="addgallerycode.php" enctype="multipart/form-data">
	                    <div class="form-group" style="margin-top:10px;">
	                    	...
	                    	<div class="row">
	                    		<div class="col-md-12">
	                    			<div class="col-md-3">
		                    			<thead>
		                    				<label class="control-label" style="padding-left:5%;" align=""><h4><b>Gallery Image</b></h4></label>
		                    			</thead>
		                    		</div>
	                    		</div>
	                    		<div class="col-md-12">
